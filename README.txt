...
For regular use, open AI_MOVIE_STUDIO.html in a modern browser. No Python or build step is required.
...
All data remains local to the browser until a future backend is connected.
