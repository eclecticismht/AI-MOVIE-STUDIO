...
function saveStoryboardShot(id){
  ...
  if(updated.continueFromShotId&&(updated.firstFrameUrl||updated.renderMode==='black'||shotDialogueEvents(updated).some(e=>e.type==='speech')))return alert('承接镜头应无口头对白、无独立首帧且不是纯黑镜头');
