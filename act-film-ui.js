const AF={acts:[],key:'',registered:'',busy:false,selected:null,version:null,drafts:new Map(),error:'',approving:null,reviewError:'',reviewEpoch:0};
...
async function syncActFilms(){
 ...
 try{
  ...
  if(AF.key!==key){AF.selected=null;AF.version=null;AF.reviewError=''}AF.key=key;AF.acts=out.acts;AF.registered=signature;AF.error='';renderActFilms();
