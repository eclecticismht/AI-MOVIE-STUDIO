...
function workspaceStatus(message){workspaceSave.message=message;let el=document.getElementById('workspaceSaveStatus');if(!el){el=document.createElement('div');el.id='workspaceSaveStatus';el.setAttribute('role','status');el.style.cssText='padding:8px 18px;background:#182332;color:#d8e6ef;font-size:13px;position:sticky;top:0;z-index:90';document.querySelector('main').prepend(el)}el.textContent=message;
